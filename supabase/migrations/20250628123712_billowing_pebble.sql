/*
  ...
  2. Security
    ...
    - Set up admin functions and audit trails
  
  3. Features
    - User role management system
    - Event management for NGOs and admins
...
DO $$ BEGIN
  CREATE TYPE question_type AS ENUM ('forced_choice', 'likert_scale', 'mcq', 'open_ended', 'sjt', 'true_false');
EXCEPTION
