/*
  # Complete Database Schema Setup for Fortitude Network
  ...
  2. Schema Updates
    ...
    - Update enums to include all required values
...
-- Update existing enums to include all required values
-- First, let's check what enums exist and update them safely
...
DO $$ 
BEGIN
  -- Add role column FIRST before other columns that might reference it
  IF NOT EXISTS (
